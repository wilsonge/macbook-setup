...
## Installation
  ...
  2. [Install Ansible](http://docs.ansible.com/intro_installation.html). Ensure the python being used is located in your path in the .bash_profile
  3. Run pip install lxml (required for the IntelliJ plugins to install)
